...
protocol StoneTextFieldViewDelegate: AnyObject {
    func updateNameValue(name: String)
}

class StoneTextFieldView: UIView, UITextFieldDelegate {
    ...
    private lazy var errorLabel: UILabel = {
        ...
        label.text = "obligateField".localized
        return label
    }()
    ...
    // MARK: Vars
    weak var delegate: StoneTextFieldViewDelegate?
